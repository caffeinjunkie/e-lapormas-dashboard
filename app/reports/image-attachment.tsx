...
export const ImageAttachment = ({
  ...
  return (
    <Card
      ...
      onPress={onPress}
      className={clsx(
        "hidden sm:flex flex-row min-h-14 justify-between items-center w-full shadow-none border-1 border-default-200 hover:bg-default-100 hover:scale-105 rounded-xl",
        className,
      )}
    >
      {loading ? (
